# When testing 100 out of 1000 images were wrong - Therefore accuracy is 90.0%%
...
for x in range(1, 1001):
    test_image = image.load_img('/Users/intern.mac/Desktop/RPi-Self-Driving-Car/cardataset/testing_set/Left/trainframe ('+str(x)+').png', target_size=(64, 64))
